...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 61.0, 7.0, 150.0, 20.0 ],
					"text" : "retain-dictionaries"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 4,
					"numoutlets" : 0,
					"patching_rect" : [ 482.0, 80.0, 50.5, 22.0 ],
					"text" : "bgcolor"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 412.0, 6.0, 128.0, 32.0 ],
					"saturation" : 1.0
				}
...
,
					"patching_rect" : [ 684.0, 200.0, 113.5, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 399.0, 30.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 917.0, 125.0, 22.0, 22.0 ],
					"text" : "t b",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 917.0, 2.0, 30.0, 30.0 ],
...
,
					"patching_rect" : [ 628.0, 340.0, 71.0, 22.0 ],
					"text" : "p retain-dict",
...
,
					"patching_rect" : [ 549.0, 340.0, 71.0, 22.0 ],
					"text" : "p retain-dict",
...
,
					"patching_rect" : [ 469.0, 340.0, 71.0, 22.0 ],
					"text" : "p retain-dict",
...
,
					"patching_rect" : [ 390.0, 340.0, 71.0, 22.0 ],
					"text" : "p retain-dict",
...
,
					"patching_rect" : [ 313.0, 340.0, 71.0, 22.0 ],
					"text" : "p retain-dict",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 180.5, 50.0, 151.0, 47.0 ],
...
,
					"patching_rect" : [ 236.0, 340.0, 71.0, 22.0 ],
					"text" : "p retain-dict",
...
,
					"patching_rect" : [ 86.0, 340.0, 71.0, 22.0 ],
					"text" : "p retain-dict",
...
,
					"patching_rect" : [ 11.0, 340.0, 71.0, 22.0 ],
					"text" : "p retain-dict",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 10,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 11.0, 125.0, 490.0, 22.0 ],
...
, 			{
		...
		"dependency_cache" : [  ],
		"autosave" : 0,
		"bgcolor" : [ 0.0, 0.171875, 0.6875, 1.0 ]
	}
